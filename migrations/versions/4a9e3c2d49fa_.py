...
Revision ID: 4a9e3c2d49fa
Revises: 
Create Date: 2025-04-22 18:35:32.223844
...
def upgrade():
    ...
    sa.Column('id_inventory', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('name', sa.String(length=100), nullable=False),
